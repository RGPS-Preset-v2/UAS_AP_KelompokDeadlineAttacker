...
Deskripsi Projek: Proyek ini adalah aplikasi Game Tebak Kata berbasis Command Line Interface (CLI) menggunakan bahasa pemrograman C++. Konsep permainannya mirip dengan "Hangman", di mana pemain harus menebak sebuah kata rahasia huruf demi huruf sebelum "nyawa" (kesempatan menebak) mereka habis. Jika tebakan benar, huruf akan terbuka pada posisi yang sesuai. Jika salah, nyawa berkurang dan huruf tersebut dicatat agar pemain tahu huruf apa saja yang sudah ditebak. Tujuan Akademis: Memenuhi standar kelulusan UAS Lab Algoritma dan Pemrograman dengan mengimplementasikan konsep-konsep inti C++ secara terpadu.
